...
@slot('title') Employee Termination and Offboarding Dashboard @endslot
@endcomponent
        ...
        <div class="col-sm-7 col-xl-4">
            <div class="card card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill text-end">
                        <h4 class="mb-0">0</h4>
                        <span class="text-muted">Total Employees Offboarding</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-7 col-xl-4">
            <div class="card card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill text-end">
                        <h4 class="mb-0">0</h4>
                        <span class="text-muted">Total of Employee Terminated</span>
                    </div>
                </div>
            </div>
        </div>
