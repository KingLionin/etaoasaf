...
<div class="content d-flex justify-content-center align-items-center">
    ...
    <div class="flex-fill">
        ...
        <div class="text-center mb-4">
            ...
            <h6 class="w-md-25 mx-md-auto">Oops, an error has occurred. <br> The service you requested is not available at this time. Please try again later.</h6>
        </div>
        <!-- /error title -->
