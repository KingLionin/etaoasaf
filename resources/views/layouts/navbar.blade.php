    ...
    <div class="container-fluid">
        ...
        <div class="navbar-brand flex-1 flex-lg-0">
            <a href="index" class="d-inline-flex align-items-center">
                ...
                <span class="d-none d-sm-inline-block h-30px ms-3 text-white" style="font-family: Arial; font-size: 25px; font-weight:bold; text-decoration:none;">WORKFOLIO HUMAN RESOURCE</span>
            </a>
        </div>
        ...
        <ul class="nav flex-row justify-content-end order-1 order-lg-2">
            ...
            <li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
                <a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
                    ...
                    <span class="d-none fw-bold d-lg-inline-block mx-lg-2">{{auth()->user()->name}}</span>
                </a>
